...
namespace Core.CrossCuttingConcerns.Caching.Microsoft
{
    class MemoryCacheManager : ICacheManager
    {
        ...
        public bool IsAdd(string key)
        {
            ...
            return _memoryCache.TryGetValue(key, out _);//out _ --> istenilen 2. parametreyi istemiyorsak böyle yapabiliriz.
        ...
        public void RemoveByPattern(string pattern)
        {
            ...
            var cacheEntriesCollection = cacheEntriesCollectionDefinition.GetValue(_memoryCache) as dynamic;//definitaion u _memoryCache olanları bul.
